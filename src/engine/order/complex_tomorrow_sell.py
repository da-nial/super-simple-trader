...
from engine.order.tomorrow_sell import TomorrowSell


class ComplexTomorrowSell(ComplexOrder):
    ...
    def __init__(self, opening_price, limit_price, amount):
        ...
        self.order_today_tomorrow = 'فردایی'
    ...
    def add_to_list(self, offer_price, offer_amount, event_sender, event_time):
        self.simple_orders.append(TomorrowSell(offer_price, offer_amount, event_sender, event_time))

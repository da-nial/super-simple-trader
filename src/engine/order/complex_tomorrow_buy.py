...
from engine.order.tomorrow_buy import TomorrowBuy


class ComplexTomorrowBuy(ComplexOrder):
    ...
    def add_to_list(self, offer_price, offer_amount, event_sender, event_time):
        self.simple_orders.append(TomorrowBuy(offer_price, offer_amount, event_sender, event_time))
